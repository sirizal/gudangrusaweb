...
namespace App\Filament\Purchasing\Resources\PurchaseOrders\Schemas;
            ...
            ->components([
                Section::make('Purchase order')
                    ...
                    ->schema([
                        ...
                        DatePicker::make('po_date')->required()->default(now()),
                        ...
                        Select::make('payment_term_id')
                            ...
                            ->preload()->searchable(),
                        TextInput::make('po_code')->label('PO code')->disabled()->dehydrated(false)->visibleOn('edit'),
                        Select::make('status')->options(PurchaseOrderStatus::class)->disabled()->dehydrated(false)->visibleOn('edit'),
                        TextInput::make('discount_amount')->label('Discount')->numeric()->default(0)->minValue(0)->prefix('Rp'),
                        ...
                        Repeater::make('lines')
                            ...
                            ->schema([
                                Select::make('purchase_type')
                                    ...
                                    ->default('inventory')->required()->live(),
                                Select::make('product_id')
                                    ...
                                    ->required(fn (Get $get): bool => ! PurchaseRequestForm::isAccountType($get('purchase_type'))),
