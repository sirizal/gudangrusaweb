...
namespace App\Filament\Purchasing\Resources\Vendors\RelationManagers;
...
class VendorAddressesRelationManager extends RelationManager
{
        ...
        return $schema
            ...
            ->schema([
                TextInput::make('address_code')
                    ...
                    ->required()
                    ->maxLength(30)
                    ->unique(ignoreRecord: true, modifyRuleUsing: fn ($rule, $livewire) => $rule->where('vendor_id', $livewire->getOwnerRecord()->id)),
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                TextColumn::make('address_code')->searchable()->sortable(),
                TextColumn::make('label')->placeholder('—'),
                TextColumn::make('village.name')->label('Village')->placeholder('—'),
