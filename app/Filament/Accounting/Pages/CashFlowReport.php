...
class CashFlowReport extends Page
{
    ...
    protected string $view = 'filament.pages.accounting.cash-flow-report';
    ...
    {
        return app(FinancialStatementService::class)->cashFlowStatement($this->fiscalYearId, $this->periodNumber, $this->asOfDate);
    }
