...
class BalanceSheetReport extends Page
{
    ...
    protected string $view = 'filament.pages.accounting.balance-sheet-report';
    ...
    {
        return app(FinancialStatementService::class)->balanceSheet($this->fiscalYearId, $this->periodNumber, $this->asOfDate);
    }
