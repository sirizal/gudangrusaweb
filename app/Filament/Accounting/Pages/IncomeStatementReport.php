...
class IncomeStatementReport extends Page
{
    ...
    protected string $view = 'filament.pages.accounting.income-statement-report';
    ...
    {
        return app(FinancialStatementService::class)->incomeStatement($this->fiscalYearId, $this->periodNumber, $this->asOfDate);
    }
