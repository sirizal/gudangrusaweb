<x-filament-panels::page>
    <form wire:submit="preview" class="fi-section rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10">
        <div class="fi-section-header px-6 py-4">
            <h2 class="fi-section-header-heading text-base font-semibold leading-6 text-gray-950 dark:text-white">Import catalog</h2>
        </div>
        <div class="fi-section-content px-6 pb-6">
            ...
            <p class="mt-3 text-xs text-gray-500 dark:text-gray-400">
                Choose the data type and upload a CSV or Excel file. Use the Download template button to get the expected columns.
                Re-importing skips rows that already exist (matched by code / slug / SKU).
            </p>
        </div>
    </form>
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                            @forelse ($previewRows as $row)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                                    ...
                                    <td class="px-6 py-2 font-mono text-gray-500 dark:text-gray-400">{{ $row['key'] }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-8 text-center text-gray-500 dark:text-gray-400">No rows.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
